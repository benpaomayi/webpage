...
//MY
        ...
        switch (<?php echo $row_Recordset_task['csa_type']?>)
        {
        case 7:
        	d.add(Number(r[i].id),Number(r[i].pid),r[i].name,"default_task_edit3.php?pagetab=alltask&editID="+r[i].id,r[i].title);
          break;
        case 3:
        	d.add(Number(r[i].id),Number(r[i].pid),r[i].name,"default_task_edit2.php?pagetab=alltask&editID="+r[i].id,r[i].title);
          break;
        case 2:
