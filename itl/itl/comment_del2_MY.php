...
$query_Recordset_comment = sprintf("SELECT * FROM tk_comment2 WHERE coid = %s", GetSQLValueString($_GET['delID'], "int"));
...
if ((isset($_GET['delID'])) && ($_GET['delID'] != "") && ($_SESSION['MM_Username'] <> $multilingual_dd_user_readonly)) {
  $deleteSQL = sprintf("DELETE FROM tk_comment2 WHERE coid=%s",
...
if( $projectid== "-1"){
    $deleteGoTo = "default_task_edit3.php?editID=$taskid";
 } else if($date <> "-1"){
