...
$newID = add_task( $_POST['csa_from_dept'], $_POST['csa_from_user'], $_POST['csa_to_dept'], $_POST['csa_to_user'], $project_id, $_POST['csa_type'], $_POST['csa_text'], $_POST['csa_priority'], $_POST['csa_temp'], $_POST['plan_start'], $_POST['plan_end'], $_POST['plan_hour'],$_POST['csa_zixun_fei'],$_POST['csa_yongtu_fei'], $_POST['csa_remark2'], $_POST['csa_create_user'], $_POST['csa_last_user'], $task_id, $wbs, $wbs_id, $_SESSION['MM_uid'], $csa_tag, $csa_remark1 );
  ...
  $insertGoTo = "default_task_edit3.php?editID=$newID";
...
-->          
          ...
          <tr>
            <td><input name="csa_tag" id="csa_tag" type="text" value="" class="width-p100-big" placeholder="<?php echo "项目编号（如软著著作权号）";?>"  style="display:none"></td>
          </tr>
...
-->
            ...
            <td valign="top" style="display:none"><input type="text" name="plan_hour" id="plan_hour" value="<?php echo $row_Recordset_task['csa_plan_hour']; ?>" size="20"  />
        <?php echo $multilingual_global_hour; ?><span id="plan_hour_msg"></span></td>
          </tr>
      ...
      <td valign="top" style="display:none"><input type="text" name="csa_zixun_fei"  value="<?php echo $row_Recordset_task['csa_zixun_fei']; ?>" size="20"  />
      ...
      <!--  -->    
          ...
          <tr>          
            ...
            <td valign="top" style="display:none"><select name="csa_priority">
<!-- 论文类型（论文选填）            
...
--> 
 ...
 <!-- 缴费方式 -->     
          <tr>      
            ...
            <td valign="top" style="display:none"><select name="csa_temp">
          ...
          <tr>
            ...
            <td valign="top"  style="display:none"><select name="csa_remark2" id="csa_remark2" >
                <?php
do {  
?>
