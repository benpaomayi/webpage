...
$mail_subject = $nowuser.$multilingual_sendyoujian." ".$email_title;
...
$mail_body = $multilingual_sendyoujian2.$nowuser.$multilingual_sendyoujian3." <a href='".$host_url."default_task_edit.php?editID=".$email_id."&pagetab=mtask'>".$email_title."</a>";
}
