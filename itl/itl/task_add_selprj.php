...
<?php if($section ==1){?>
<table align="center" class="table table-striped table-hover glink" width="100%">
	...
	<?php do { ?>
	  ...
	  <a onclick="javascript:parent.parent.location='default_task_add.php?projectID=<?php echo $row_Recordset1['id']; ?>&UID=<?php echo $user_id; ?>&touser=<?php echo $touser; ?>';" href="#">
...
<tr><td ><a href="javascript:history.go(-1)"><b><?php echo $multilingual_taskadd_back; ?></b></a></td></tr>
	...
	<?php do { ?>
	  ...
	  <div class="float_right">
	  <a onclick="javascript:parent.parent.location='default_task_add.php?taskID=<?php echo $row_Recordset_subtask['TID']; ?>&projectID=<?php echo $row_Recordset_subtask['csa_project']; ?>&wbsID=<?php echo $wbsID; ?>&UID=<?php echo $user_id; ?>&touser=<?php echo $touser; ?>';" href="#">
			 <i class="icon-random"></i> <?php echo $multilingual_project_newtask; ?>			 </a>
