...
-->          
          ...
          <tr>
            <td><input name="csa_tag" id="csa_tag" type="text" value="" class="width-p100-big" placeholder="<?php echo "项目编号（如软著著作权号）";?>"></td>
          </tr>
        </table></td>
...
-->
      ...
      <!--  --> 
       <!-- 缴费用途 -->
      <tr>
      <td valign="top"><?php echo "缴费用途"; ?></td>
      <td valign="top"><input type="text" name="csa_yongtu_fei"  value="<?php echo $row_Recordset_task['csa_yongtu_fei']; ?>" size="20"  />
      </td>
      </tr>
      <!--  -->    
