...
//add task
function add_task( $fdept, $fuser, $tdept, $tuser, $projectid, $type, $text, $priority, $temp, $start, $end, $hour,$zixunfei, $yongtu,$status, $cuser, $luser, $taskid, $wbs, $wbsid, $nowuser, $tag, $remark ) {
global $tankdb;
global $database_tankdb;
global $multilingual_log_addtask;
$insertSQL = sprintf("INSERT INTO tk_task (test02, csa_remark1, csa_from_dept, csa_from_user, csa_to_dept, csa_to_user, csa_project, csa_type, csa_text, csa_priority, csa_temp, csa_plan_st, csa_plan_et, csa_plan_hour,csa_zixun_fei,csa_yongtu_fei,csa_remark2, csa_create_user, csa_last_user, csa_remark4, csa_remark5, csa_remark6, csa_project_sub, csa_remark7, csa_remark8, test01, test03, test04) VALUES ($tag $remark %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, '0', '', '', '', '', '')",
		            ...
		            GetSQLValueString($zixunfei, "text"),
		            GetSQLValueString($yongtu, "text"),
...
if($type=="newtask"){
 ...
 $text = $multilingual_message_newtask." <a href='project_view.php?recordID=".$project_id."&pagetab=mtask'>".$title."</a>";
if($mail_create=="on"){
