...
<div class="ui-widget" style="margin:auto auto; width:350px;" >
			<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;"> 
				...
				<?php echo $multilingual_error_logintext; ?> <a href="javascript:history.go(-1)"><?php echo $multilingual_global_action_back; ?></a> / <a href="../../login.html"><?php echo $multilingual_error_login; ?></a></p>
			</div>
		</div>
</body>
</html>