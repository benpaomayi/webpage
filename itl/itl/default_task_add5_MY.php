  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	 ...
	 echo $multilingual_subtask_root;
          ...
          <tr>
            <td >
              <span class="font_big18 fontbold"   style="display:none"><?php echo $multilingual_taskadd_title; ?></span> </td>
          </tr>
          <tr>
<!--  论文名称          
...
--> 
          ...
          <td><input type="text" name="csa_text" id="csa_text" value="<?php echo $row_Recordset_project['project_name']; ?>" size="50" class="width-p100-big" placeholder="<?php echo $multilingual_project_title; ?>"  style="display:none"/>
          <span id="csa_text_msg"></span></td>        
          </tr>
...
-->          
          ...
          <tr>
            <td><input name="csa_tag" id="csa_tag" type="text" value="" class="width-p100-big" placeholder="<?php echo "成果编号（如专利号）";?>"  style="display:none"></td>
          </tr>
          
          <tr>
          <td> <?php echo "确定要提交审批吗？如果确定，请点击下面“保存”按钮，否者点击“取消”按钮";?> </td>
          </tr>
          
        </table></td>
      <td width="30%"  valign="top"><table width="96%" border="0" cellspacing="0" cellpadding="5" align="right">
          <tr>
...
<!-- 事务类型 -->                
 <td valign="top" style="display:none"><?php echo $multilingual_default_task_type; ?></td>
            <td valign="top"><?php 
	if ($row_Recordset_countlog['count_log'] <> "0") { ?>
        <?php } ?>
        <select name="csa_type" id="csa_type"  style="display:none"  onchange="option_gourl(this.value)" 
		 <?php 
	if ($row_Recordset_countlog['count_log'] <> 0) { 
...
?>
 ...
 <!--  -->             
          ...
          <tr>
            <td valign="top" style="display:none"><?php echo $multilingual_default_task_to; ?></td>
            <td valign="top"><input type="text" id="select3" name="csa_to_dept" value="0001" style="display:none;" />
              <select id="select4" name="csa_to_user" style="display:none"  onChange="option_gourl(this.value)">
...
?>
 ...
 -->      
       ...
       <?php switch ($_SESSION['MM_uid'] ) {                 
   	
   	case '13': echo '  <option value="14" >高明</option>';
   	case '14': echo '  <option value="15" >王伟明</option>';
             } ?>        
              </select>
    
               
            <span id="csa_to_user_msg"></span>
			<br /><span class="gray" style="display:none"><?php echo $multilingual_taskadd_totip; ?></span>
			</td>
          </tr>
          <tr>
            <td valign="top" style="display:none" ><?php echo $multilingual_default_task_from; ?></td>
            <td valign="top"><input type="text" id="select1" name="csa_from_dept" value="0001" style="display:none;"  />
              <select id="select2" name="csa_from_user"  style="display:none"  onChange="option_gourl(this.value)">
...
?>
          ...
          <tr>
            <td valign="top" style="display:none"><?php echo $multilingual_default_task_planstart; ?></td>
            <td valign="top"><input type="text" name="plan_start" id="datepicker2" value="<?php echo date('Y-m-d'); ?>" size="20"  style="display:none"/>
            <span id="csa_plan_st_msg"></span></td>
          </tr>
          <tr>
            <td valign="top" style="display:none"><?php echo $multilingual_default_task_planend; ?></td>
            <td valign="top"><input type="text" name="plan_end" id="datepicker3" value="<?php echo $row_Recordset_task['csa_plan_et']; ?>" size="20"  style="display:none"/>
...
-->
            <tr>
            <td valign="top"  style="display:none"><?php echo $multilingual_default_task_planhour; ?></td>
            <td valign="top"><input type="text" name="plan_hour" id="plan_hour" value="<?php echo $row_Recordset_task['csa_plan_hour']; ?>" size="20"  style="display:none"/>
            <span id="plan_hour_msg"></span></td>
          </tr>
      
      <!-- 咨询费 -->
      <tr>
      <td valign="top" style="display:none"><?php echo "咨询费"; ?></td>
      <td valign="top"><input type="text" name="csa_zixun_fei"  value="<?php echo $row_Recordset_task['csa_zixun_fei']; ?>" size="20" style="display:none" />
      </td>
      </tr>
      <!--  --> 
       <!-- 缴费用途 -->
      <tr>
      <td valign="top" style="display:none"><?php echo "缴费用途"; ?></td>
      <td valign="top"><input type="text" name="csa_yongtu_fei"  value="<?php echo $row_Recordset_task['csa_yongtu_fei']; ?>" size="20"  style="display:none"/>
      </td>
      </tr>
      <!--  -->      
          ...
          <tr>          
            <td valign="top" style="display:none"><?php echo "事务所"; ?></td>
            <td valign="top"><select name="csa_priority"  style="display:none" >
<!-- 论文类型（论文选填）            
...
--> 
 ...
 <!-- 缴费方式 -->     
          <tr>      
            <td valign="top"  style="display:none"><?php echo $multilingual_default_tasklevel; ?></td>
            <td valign="top"><select name="csa_temp"  style="display:none">
                <option value="5" SELECTED=“SELECTED”><?php echo $multilingual_dd_level_l5; ?></option>
                <option value="4"><?php echo $multilingual_dd_level_l4; ?></option>
                <option value="3" ><?php echo $multilingual_dd_level_l3; ?></option>
          ...
          <tr>
            <td valign="top" style="display:none"><?php echo $multilingual_default_taskstatus; ?></td>
            <td valign="top"><select name="csa_remark2" id="csa_remark2" style="display:none">
                <?php
do {  
?>
