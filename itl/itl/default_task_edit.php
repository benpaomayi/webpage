    ...
    <td  valign="top">
	 ...
	 echo $multilingual_subtask_root;
	  ...
	  <li class="float_right"><?php echo $multilingual_default_taskid; ?>: <?php echo $row_Recordset_task['TID']; ?></li>
        ...
        <tr>
          <td><span class="gray"><font size="5"><?php echo "刊物或会议名称：".$row_Recordset_task['test02']; ?></font></span> </td>
        </tr>
        <?php } ?>
		<tr>
	  ...
	  ?></td>
        ...
        <tr>
		  ...
		  <tr>
			...
			<td width="16%">
			<a onclick="javascript:self.location='default_task_add4_MY.php?taskID=<?php echo $colname_Recordset_task; ?>&projectID=<?php echo $row_Recordset_task['proid']; ?>&wbsID=<?php echo $wbsID; ?>';"  class="mouse_over"><i class="icon-random"></i> <?php echo $multilingual_project_newtask; ?></a>
            </td>
            <?php }  ?>
...
<!-- 事务所 -->
                    <td><?php
switch ($row_Recordset_subtask['csa_shiwusuo'])
{
case 3:
  echo "求是";
  break;
