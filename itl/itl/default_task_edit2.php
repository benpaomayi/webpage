	  ...
	  ?></td>
        ...
        <tr>
		  ...
		  <tr>
			...
			<td width="16%">			
			 <a onclick="javascript:self.location='default_task_add5_MY.php?taskID=<?php echo $colname_Recordset_task; ?>&projectID=<?php echo $row_Recordset_task['proid']; ?>&wbsID=<?php echo $wbsID; ?>';"  class="mouse_over"><i class="icon-random"></i> <?php echo $multilingual_project_newtask; ?></a>           
            </td>
            <?php }  ?>
