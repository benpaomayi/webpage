...
-->          
          ...
          <tr>
            <td><input name="csa_tag" id="csa_tag" type="text" value="" class="width-p100-big" placeholder="<?php echo "刊物名称（或会议名称）";?>" style="display:none" ></td>
          </tr>
          <tr>
...
-->
        ...
        <span id="plan_hour_msg"></span></td>
          ...
          <tr>          
            <td valign="top" style="display:none" ><?php echo $multilingual_default_task_priority; ?></td>
