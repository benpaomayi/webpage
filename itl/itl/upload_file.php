...
<html>
<head>
<title>ITL实验室 - <?php echo $multilingual_upload_title; ?></title>
...
//$destination = $destination_folder.$named."_".md5(time());

$destination = $destination_folder.date("Ymd")."_".$named;
//$destination_title = $destination_folder.md5(time())."_".$names;

$destination_title = date("Ymd")."_".$names;
