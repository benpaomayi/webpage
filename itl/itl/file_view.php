...
<table width="100%">
  ...
  <tr>
	...
	<table width="100%" align="center">
        <tr>
		<td>
	<h2><?php echo $row_DetailRS1['tk_doc_title']; ?></h2></td>
	</tr>
        <tr>
          <td>
		  <table width="100%" align="center">
		...
		<?php if ($row_DetailRS1['tk_doc_attachment'] <> "" && $row_DetailRS1['tk_doc_attachment'] <> " ") { //显示附件下载地址，如果有 ?>
		  ...
		  <td width="10%">
		  <i class="icon-pencil"></i> <a href="file_edit.php?editID=<?php echo $row_DetailRS1['docid']; ?>&projectID=<?php 
	  ...
	  echo "&pfile=1";
		  ...
		  <?php } ?>
		  <td width="10%">
		  <i class="icon-remove-sign"></i> <a onClick="window.opener.location.reload(); window.close();" class="mouse_hover"><?php echo $multilingual_global_action_close; ?></a>
		  </td>
		  <td>&nbsp;
		  </td>
        </tr>
  ...
  <tr>
    <td class="file_text_bg">
	<table class="table table-striped table-hover glink" style="width:940px;" align="center">
	<?php do { ?>
        <tr>
