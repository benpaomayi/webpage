<?php 
  ...
  // *任务优先级
$multilingual_dd_priority_p5 = "";
$multilingual_dd_priority_p4 = "SCI期刊";
$multilingual_dd_priority_p3 = "EI期刊";
$multilingual_dd_priority_p2 = "国内一级期刊";
$multilingual_dd_priority_p1 = "高层次国际会议";
 
  // *缴费方式
$multilingual_dd_level_l5 = "借款转账";
$multilingual_dd_level_l4 = "";
$multilingual_dd_level_l3 = "";
$multilingual_dd_level_l2 = "";
$multilingual_dd_level_l1 = "";
...
$multilingual_dd_project_inside = "内部审批项目";  
$multilingual_dd_project_outside = "外部审批项目";  
// *** 数据字典结束***********************************************
...
$multilingual_dd_role_pm = "老师";
$multilingual_dd_role_general = "学生";
...
$multilingual_head_task = "审批跟踪";
$multilingual_head_log = "日志";
$multilingual_head_project = "成果申报";
$multilingual_head_file = "发票管理";
...
$multilingual_default_taskid = "审批事务ID";
$multilingual_default_tasktag = "Tag";
$multilingual_default_searchtip = "默认显示当前用户、当年、当月的任务";
$multilingual_default_sorrytipup = "没有审批信息";
$multilingual_default_sorrytipdown = "或尝试访问以下链接:";
$multilingual_default_newtask = "提交审批";
$multilingual_default_tome = "提交给我";
$multilingual_default_fromme = "来自我的审批";
$multilingual_default_createme = "我提交的审批";
$multilingual_default_shortcut = "快捷方式:";
$multilingual_default_task_id = "ID";
$multilingual_default_task_title = "成果名称";
$multilingual_default_task_description = "成果相关文件";
$multilingual_default_task_to = "提交给";
$multilingual_default_task_totalhour = "";
$multilingual_default_task_manhour = "工时";
$multilingual_default_task_status = "状态";
$multilingual_default_task_planstart = "提交审批时间";
$multilingual_default_task_planend = "规定缴费日期";
$multilingual_default_task_planhour = "发表的费用";
$multilingual_default_task_type = "事务类型";
$multilingual_default_task_project = "所属成果";
$multilingual_default_task_from = "来自";
$multilingual_default_task_createby = "由谁创建";
$multilingual_default_task_editby = "由谁修改";
$multilingual_default_task_priority = "论文类型";
...
$multilingual_default_task_section5 = "审批日志";
$multilingual_default_task_others = "其他信息";
$multilingual_default_task_parent = "上级成果审核";
$multilingual_default_task_subtask = "提交给";
...
$multilingual_default_addcom = "填写借款经费卡";
$multilingual_default_editcom = "编辑评论";
$multilingual_default_comment = "备注信息";
$multilingual_default_by = "于";
$multilingual_default_at = "填写的备注信息";
$multilingual_default_required1 = "请指定一个人";
$multilingual_default_required2 = "请选择一个项目";
$multilingual_default_required3 = "请选择事务类型";
...
$multilingual_taskadd_title = "提交审批";
$multilingual_taskedit_title = "重新编辑";
$multilingual_tasklog_title = "事务详情";
...
$multilingual_tasktype_lock = "该任务已产生日志或没有提交给你，执行人不可编辑";
...
$multilingual_outofdate_title = "以下审批已到期，请确定是否被老师审批！";
$multilingual_outofdate_outofdate = "已过期";
$multilingual_outofdate_date = "天";
$multilingual_outofdate_totle = "个过期审批";
...
$multilingual_calendar_others = "该任务没有提交给您，无法进行日志操作";
...
$multilingual_taskf_priority = "全部论文类型";
$multilingual_taskf_level = "全部紧急程度";
$multilingual_taskf_project = "全部项目";
$multilingual_taskf_touser = "审批人";
$multilingual_taskf_fromuser = "提交人";
$multilingual_taskf_createuser = "不限创建人";
$multilingual_tasks_title = "按成果名称搜索";
$multilingual_tasks_tid = "按任务ID搜索";
$multilingual_tasks_tag = "按任务TAG搜索";

$multilingual_subtask_root = "导师审核";
$multilingual_subtask_cost = "子任务工时汇总";
$multilingual_subtask_plan = "发表费用";

$multilingual_taskadd_selprj = "请选择已创建的项目或新建项目";
$multilingual_taskadd_back = "返回上一级";
$multilingual_taskadd_nosub = "请返回上一级";
$multilingual_default_alltask = "所有审批";

$multilingual_taskadd_title_plh = "请填写论文或专利名称";
$multilingual_taskadd_totip = "审批老师";

$multilingual_default_task_planpv = "发表费用";
...
$multilingual_project_title = "成果名称";
$multilingual_project_titleadd=":请填写论文或专利名称";
$multilingual_project_code = "作者名称";
$multilingual_project_start = "提交时间";
$multilingual_project_end = "要求审批完成时间";
$multilingual_project_touser = "提交人";
$multilingual_project_status = "成果类型";
...
$multilingual_project_description = "成果相关文件";
...
$multilingual_project_none = "没有符合条件的成果信息";
$multilingual_project_none2 = "还没创建项目";
$multilingual_project_tips = "为了方便查询，请选择成果类型";
$multilingual_project_tips2 = "";
...
$multilingual_project_view_wbs = "";
$multilingual_project_view_log = "项目日志";
$multilingual_projectlist_title = "项目管理";
$multilingual_projectlist_new = "成果申报";
$multilingual_projectlist_search = "按成果名称搜索";
$multilingual_projectlist_edit = "重新编辑";
...
$multilingual_projectstatus_edit = "编辑成果状态";
$multilingual_projectstatus_titlerequired = "2-128个字符";
$multilingual_project_taskoverlay = "工时消耗分布";
$multilingual_project_hour = "小时";
$multilingual_project_newtask = "提交审批";
$multilingual_project_newtask1="(";
$multilingual_project_newtask2=")";

$multilingual_projectmem_title = "实验室成员管理";
$multilingual_projectmem_text = "由于ITL实验室的该功能功能处于扩展中，不能为您提供服务，您可以为一个项目组添加固定的成员，所有项目相关的内容，如：任务、文档、日志、项目详情等，只对该项目组的成员开放。";

$multilingual_project_view_nowbs = "操作说明";
$multilingual_project_view_nowbstext = "<p>点击“提交审批”，可以把该审批事务提交给相应的老师。</p><br />
<p>您可以点击“编辑”或“返回”，可以回到您刚创建审批任务的页面重新编辑。</p>
";

// *** 文档管理
$multilingual_project_file = "成果发票";
$multilingual_project_file_management = "发票信息";
...
$multilingual_project_file_addfile = "发票管理";
...
$multilingual_project_file_filetitle = "请填写票务信息（如：借款单或发票）";
$multilingual_project_file_filetext = "文档正文";
$multilingual_project_file_nofile = "没有发票信息";

$multilingual_project_file_myfile = "我提交成果的发票";
$multilingual_project_file_myeditfile = "我提交成果的发票";
$multilingual_project_file_allfile = "所有成果票务";

$multilingual_project_myprj = "我申报的成果";
$multilingual_project_jprj = "我审批的成果";
$multilingual_project_allprj = "所有申报的成果";
...
$multilingual_user_newtask2 = "提交给您";
...
$multilingual_user_view_project = "申报成果";
$multilingual_user_view_task = "近期审批";
...
$multilingual_user_tip_remark = "备注信息可选填";
...
$multilingual_user_tip_name = "建议用户名为真实姓名";
...
$multilingual_user_mytask = "提交给我的审批";
...
$multilingual_user_level = "权限";

$multilingual_user_about = "关于用户";
$multilingual_user_abouttext = "<p>用户被创建后，可以使用“帐号”与“密码”登录系统。</p>
<br />
<p>用户一旦被删除，与其相关的所有数据将无法查询，为了保证数据的完整性，我们强烈建议将其角色改为“禁用”，而非直接删除用户。</p>
<br />
...
$multilingual_exam_tip = "";
$multilingual_exam_wait = "待我审核的任务";
$multilingual_exam_check = "作为审核结果";
$multilingual_exam_yes = "是";

$multilingual_exam_tip2 = "审核过的论文，专利或软著可以在【来自我的审批】中查询。";

// *** 权限
$multilingual_rank1 = "登录系统";
$multilingual_rank2 = "上传文件";
$multilingual_rank3 = "添加评论";
$multilingual_rank4 = "发票管理";
$multilingual_rank5 = "审批成果";
$multilingual_rank6 = "成果管理";
$multilingual_rank7 = "用户管理";
$multilingual_rank8 = "查看用户信息";
$multilingual_rank9 = "系统设置";

// *** 消息
$multilingual_ = "消息";
$multilingual__time = "接收时间";
...
$multilingual__newmsg2 = " 条新消息";
$multilingual__nomore = "系统消息最多保留30条";

// *** login
$multilingual_getqrcode = "<br />欢迎登陆ITL实验室网站<br /><br />

<a href = '../default.php'>详见ITL实验室系统说明</a>
<br /><a href='http://weixin.qq.com' target ='_blank'></a>
";
// MY增添
